...
namespace QuickRepricer.Mws.Amazon.FBAOutboundServiceMWS.Model
{
    ...
    public class CODSettings : AbstractMwsObject
    {
        ...
        /// </summary>
        [XmlElementAttribute(ElementName = "IsCODRequired")]
        ...
        /// </summary>
        [XmlElementAttribute(ElementName = "CODCharge")]
        ...
        /// </summary>
        [XmlElementAttribute(ElementName = "CODChargeTax")]
        ...
        /// </summary>
        [XmlElementAttribute(ElementName = "ShippingChargeTax")]
