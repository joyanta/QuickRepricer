...
namespace QuickRepricer.Mws.Amazon.FBAOutboundServiceMWS.Model
{
    ...
    public class FulfillmentOrder : AbstractMwsObject
    {
        ...
        /// </summary>
        [XmlElementAttribute(ElementName = "ReceivedDateTime")]
        ...
        /// </summary>
        [XmlElementAttribute(ElementName = "FulfillmentOrderStatus")]
        ...
        /// </summary>
        [XmlElementAttribute(ElementName = "StatusUpdatedDateTime")]
