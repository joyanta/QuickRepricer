...
namespace QuickRepricer.Mws.Amazon.FBAOutboundServiceMWS.Model
{
    ...
    public class FulfillmentPreviewShipment : AbstractMwsObject
    {
        ...
        /// </summary>
        [XmlElementAttribute(ElementName = "EarliestArrivalDate")]
        ...
        /// </summary>
        [XmlElementAttribute(ElementName = "LatestArrivalDate")]
        ...
        /// </summary>
        [XmlElementAttribute(ElementName = "FulfillmentPreviewItems")]
