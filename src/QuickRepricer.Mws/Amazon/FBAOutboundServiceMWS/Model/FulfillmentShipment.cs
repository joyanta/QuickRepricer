...
namespace QuickRepricer.Mws.Amazon.FBAOutboundServiceMWS.Model
{
    ...
    public class FulfillmentShipment : AbstractMwsObject
    {
        ...
        /// </summary>
        [XmlElementAttribute(ElementName = "FulfillmentShipmentStatus")]
        ...
        /// </summary>
        [XmlElementAttribute(ElementName = "ShippingDateTime")]
        ...
        /// </summary>
        [XmlElementAttribute(ElementName = "FulfillmentShipmentItem")]
        ...
        /// </summary>
        [XmlElementAttribute(ElementName = "FulfillmentShipmentPackage")]
