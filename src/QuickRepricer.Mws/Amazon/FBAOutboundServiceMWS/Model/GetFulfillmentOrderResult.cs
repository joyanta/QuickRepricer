...
namespace QuickRepricer.Mws.Amazon.FBAOutboundServiceMWS.Model
{
    ...
    public class GetFulfillmentOrderResult : AbstractMwsObject
    {
        ...
        /// </summary>
        [XmlElementAttribute(ElementName = "FulfillmentOrder")]
        ...
        /// </summary>
        [XmlElementAttribute(ElementName = "FulfillmentOrderItem")]
        ...
        /// </summary>
        [XmlElementAttribute(ElementName = "FulfillmentShipment")]
