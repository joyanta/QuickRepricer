...
namespace QuickRepricer.Mws.Amazon.FBAOutboundServiceMWS.Model
{
    ...
    public class GetFulfillmentPreviewRequest : AbstractMwsObject
    {
        ...
        /// </summary>
        [XmlElementAttribute(ElementName = "ShippingSpeedCategories")]
        ...
        /// </summary>
        [XmlElementAttribute(ElementName = "IncludeCODFulfillmentPreview")]
        ...
        /// Gets and sets the IncludeCODFulfillmentPreview property.
        /// </summary>
        [XmlElementAttribute(ElementName = "IncludeCODFulfilmentPreview")]
    ...
    /// <summary>
        ...
        /// </summary>
        [XmlElementAttribute(ElementName = "IncludeDeliveryWindows")]
