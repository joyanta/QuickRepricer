...
using QuickRepricer.Mws.Amazon.MarketplaceWebService.Mock;
using QuickRepricer.Mws.Amazon.MarketplaceWebService.Model;
using System;
using System.Collections.Generic;
using System.IO;

namespace QuickRepricer.Mws.Amazon.MarketplaceWebService.Samples
{
    ...
    public class MarketplaceWebServiceSamples 
    {
        ...
        */
        public static void Main1(string [] args)
        {
             ...
             ***********************************************************************/
            string accessKeyId = "AKIAJWQSXIPAKQWURUBQ";
            string secretAccessKey = "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";
            ...
            ***********************************************************************/
             ...
             * marketplace ID.
             ***********************************************************************/
            const string merchantId =  "AQIZG4G92M7AL"; // "A2VJ4SRVLLF6SA";    
            ...
            //    request.MWSAuthToken = "amzn.mws.d4ac2e5c-5742-d8bf-9e87-3b98ca25b7e4"; // "amzn.mws.faac2bdf-b67b-1a4b-f4cc-e474ab8e1f21";
            ...
            //     request.ReportId = "3356916469017117";
            //     request.Report = File.Open("report.csv", FileMode.OpenOrCreate, FileAccess.ReadWrite );
             ...
             ***********************************************************************/
            {
                ...
                request.Merchant = merchantId;
                request.MWSAuthToken = "amzn.mws.d4ac2e5c-5742-d8bf-9e87-3b98ca25b7e4"; //"amzn.mws.faac2bdf-b67b-1a4b-f4cc-e474ab8e1f21"; // Optional
                request.MarketplaceIdList = new IdList();
                request.MarketplaceIdList.Id = new List<string>(new string[] { marketplaceId });
