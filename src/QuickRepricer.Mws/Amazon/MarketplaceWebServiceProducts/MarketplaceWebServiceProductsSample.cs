...
namespace QuickRepricer.Mws.Amazon.MarketplaceWebServiceProducts {
    ...
    public class MarketplaceWebServiceProductsSample {
        ...
        public static void Main1(string[] args)
        {
            ...
            string accessKey = "AKIAJWQSXIPAKQWURUBQ";

            // Developer AWS secret key
            string secretKey = "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";
        ...
        public GetCompetitivePricingForASINResponse InvokeGetCompetitivePricingForASIN()
        {
            ...
            string sellerId = "A2VJ4SRVLLF6SA";
            request.SellerId = sellerId;
            string mwsAuthToken = "amzn.mws.faac2bdf-b67b-1a4b-f4cc-e474ab8e1f21";
            request.MWSAuthToken = mwsAuthToken;
            string marketplaceId = "ATVPDKIKX0DER";
            request.MarketplaceId = marketplaceId;
            ASINListType asinList = new ASINListType();
            asinList.ASIN = new List<string>() { "B00FSA541M" };
        ...
        public GetMatchingProductResponse InvokeGetMatchingProduct()
        {
            ...
            string sellerId = "A2DEBRVRNHR4U7";
            request.SellerId = sellerId;
            string mwsAuthToken = "amzn.mws.9cac2921-7124-463b-06c9-652e25f5b9dd";
            request.MWSAuthToken = mwsAuthToken;
            string marketplaceId = "ATVPDKIKX0DER";
            request.MarketplaceId = marketplaceId;
            ASINListType asinList = new ASINListType();
