...
using System;
using System.Net;
using QuickRepricer.Mws.Amazon.MarketplaceWebServiceSellers.Model;
using QuickRepricer.Mws.Amazon.MWSClientCsRuntime;

namespace QuickRepricer.Mws.Amazon.MarketplaceWebServiceSellers
{
    ...
    public class MarketplaceWebServiceSellersException : MwsException
    {
        ...
        public MarketplaceWebServiceSellersException(string message, 
            HttpStatusCode statusCode, ResponseHeaderMetadata rhmd)
