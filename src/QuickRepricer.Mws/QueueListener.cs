...
using QuickRepricer.Mws.Workflows;
using System;
...
namespace QuickRepricer.Mws
{
    public class QueueListener
    {
        ...
        public QueueListener(IConfigurationRoot configuration, 
            ...
            IServiceCollection serviceCollection)
        {
            ...
            _configuration = _serviceProvider.GetService<IConfigurationRoot>();
        }
        ...
        private static void Reprice(RepriceCommand repriceCommnad)
        {
                  ...
                  Message requestMessage, IMessageQueue requestQueue)
        {
            Console.WriteLine("Starting the set up for: {0} with {1} at: {2}",
                 subscribeRequest.UserName, subscribeRequest.MerchantId, 
            ...
            var workflow = new SubscribeWorkflow(subscribeRequest, _messageConfiguration, 
                _configuration, _serviceProvider.GetService<IDbContext>());
